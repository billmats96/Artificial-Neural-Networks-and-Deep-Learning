...
figure
subplot(231);
plot(x,y,'bx',x,cell2mat(a13),'r'); % plot the sine function and the output of the networks
title('1 epoch');
...
title('1 epoch');
legend('target','traingda','Location','north');

subplot(233);
plot(x,y,'bx',x,cell2mat(a33),'r'); % plot the sine function and the output of the networks
title('1 epoch');
legend('target','traincgf','Location','north');

subplot(234);
plot(x,y,'bx',x,cell2mat(a43),'r'); % plot the sine function and the output of the networks
title('1 epoch');
legend('target','traincgp','Location','north');

subplot(235);
plot(x,y,'bx',x,cell2mat(a53),'r'); % plot the sine function and the output of the networks
title('1 epoch');
legend('target','trainbfg','Location','north');

subplot(236);
plot(x,y,'bx',x,cell2mat(a63),'r'); % plot the sine function and the output of the networks
title('1 epoch');
